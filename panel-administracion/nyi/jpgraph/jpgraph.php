...
// Ver:		$Id: jpgraph.php,v 1.242.2.96 2005/01/16 20:51:53 aditus Exp $
//
...
// PUBLIC METHODS
    ...
    function Stroke($aImg,$x=null,$y=null,$js="") {
...
class Legend {
    ...
    var $xmargin=5,$ymargin=3,$shadow_width=0;
    var $xlmargin=2, $ylmargin='';
    var $xpos=0.02, $ypos=0.015, $xabspos=-1, $yabspos=-1;
